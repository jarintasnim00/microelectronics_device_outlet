                            ...
                            <option
                                <?php
                                    if ($value['catId'] == $result['catId']) { ?>
                                        selected = "selected"
                                <?php } ?> value="<?php echo $result['catId']; ?>"><?php echo 
                                    $result['catName']; ?>
                            </option>
                        <?php } } ?>
                        </select>
                            ...
                            <option
                                <?php
                                    if ($value['brandId'] == $result['brandId']) { ?>
                                        selected = "selected"
                                <?php } ?> value="<?php echo $result['brandId']; ?>"><?php echo 
                                    $result['brandName']; ?>   
                            </option>
                        <?php } } ?>
                        </select>
				...
				<tr>
                    ...
                    <td>
                        <select id="select" name="type">
                            ...
                            <option selected = "selected" value="2">Components</option>
                    ...
                    <?php } else if ($value['type'] == 3){ ?>
                            <option selected = "selected" value="3">Accessories</option>
                            <option value="0">Featured</option>
                             <option value="1">General</option>
                            <option value="2">Components</option>
                        <?php } else{ ?>
